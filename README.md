...
The Python server runs on the laptop and listens for WebSocket connections.

The phone opens a web page (touchpad_client.html) in the browser.

Touch gestures on the phone are captured using JavaScript.

These gestures are sent as JSON messages via WebSocket.

The Python server receives the messages and translates them into mouse actions using PyAutoGUI.
...
http://192.168.8.109:8000/touchpad_client.html
